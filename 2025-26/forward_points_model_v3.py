...
# Updates: Removes defensemen, handles missing data properly, optimized for real data, excludes ALL team variables from features
...
class HockeyPointsPredictor:
    ...
    def prepare_features(self, df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.Series]:
        ...
        Excludes ALL team variables including those with _1, _2, _3, etc.
        """
        ...
        # Exclude variables ending with numbers and power play variables
        for col in df.columns:
            ...
            # Exclude all power play variables (pp*)
            elif col.startswith('pp'):
                exclude_cols.append(col)
                print(f"Excluding power play column: '{col}'")
    ...
    def plot_results(self, results: Dict[str, Any]):
        ...
        axes[0, 0].set_title(f'Actual vs Predicted (Forwards Only, No PP Variables)\nR² = {results["r2"]:.3f}')
...
def main():
    ...
    print("Hockey Points Predictor - No PP Variables (Forwards Only)")
    print("=" * 70)
    ...
    if best_results:
        print(f"\n{'='*70}")
        print("BEST CONFIGURATION FOUND (FORWARDS ONLY, NO PP VARIABLES)")
        print('='*70)
